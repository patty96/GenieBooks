...
<body>
	<div id="jegopickupContainer">
		<div id="jegopicContent">
			...
			<p style="padding-left:60px">*바로드림 서비스는 경품,사은품 등이 포함되지 않습니다.</p>
			...
			<table style="width:100%">
				<tr>
					<td>
						...
						<input type="button" value="바로드림 구매하기" style="WIDTH: 180pt; HEIGHT: 40pt; font-size:1.2em;">
					</td>
				</tr>
			</table>
		</div>
	...
	<br>
	<p style="font-weight:bold; font-size:1.2em; padding-left:65px" >바로드림 이용안내</p>
	<ul style="padding-left:100px;">
		<li>매장별로 수령 예상 시간이 다를 수 있으니, 주문 전에 꼭 수령 예상 시간을 확인해 주시기 바랍니다.</li>
		<li>바로드림 주문 상품 준비완료 후 7일간 미수령시 자동으로 결제 취소되고, 취소된 금액은 결제수단의 승인취소
		<br> 및 예치금으로 전환 됩니다.</li>
